...
public class RestaurantCreateRequest {
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, example = "84000", type = "string", description = "restaurant postal code")
    @Size(min = 2, max = 10)
    private String postalCode;

    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, example = "Rome", type = "string", description = "restaurant city")
    @Size(min = 2, max = 50)
    private String city;

    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, example = "Italy", type = "string", description = "restaurant country")
    @Size(min = 2, max = 30)
    ...
    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, example = "En", type = "string", description = "restaurant language")
    @Size(min = 2, max = 5)
    private String restaurantLanguage;

    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, example = "GMT+3", type = "GMT+3", description = "restaurant timezone")
    @Size(min = 2, max = 10)
    private String restaurantTimezone;

    @Schema(requiredMode = Schema.RequiredMode.REQUIRED, example = "https://imageurl.com", type = "string", description = "restaurant image URL")
    @Size(min = 2, max = 500)
