...
@Operation(
        summary = "Updates calendar day availability.",
        description = "Updates default week day availability."
)
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Successfully updated calendar day.",
        ...
        @ApiResponse(responseCode = "404", description = "Calendar day not found by id.", content =
                {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorContainer.class))})
})
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Inherited
public @interface CalendarDayUpdateOpenApi {
}