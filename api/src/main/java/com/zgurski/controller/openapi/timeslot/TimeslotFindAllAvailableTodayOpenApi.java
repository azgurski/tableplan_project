...
@Operation(
        summary = "Gets restaurant's available timeslots for today within 30 minutes.",
        description = "Gets restaurant's available timeslots for today within 30 minutes."
)
@ApiResponses({
        ...
        @ApiResponse(responseCode = "404", description = "Restaurant or timeslots not found.", content =
                {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorContainer.class))})
})
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Inherited
public @interface TimeslotFindAllAvailableTodayOpenApi {
}