...
@Operation(
        summary = "Closes all timeslots for a calendar day.",
        description = "Closes all timeslots for a calendar day (isAvailable = true to false)."
)
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Successfully closed timeslots.",
        ...
        @ApiResponse(responseCode = "404", description = "Restaurant not found by id.",
                content = {@Content(mediaType = "application/json",
...
@Inherited
public @interface TimeslotResetAllOpenApi {
}