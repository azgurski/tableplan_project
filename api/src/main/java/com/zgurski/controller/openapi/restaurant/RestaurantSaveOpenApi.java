...
@Operation(
        summary = "Creates a profile of new restaurant.",
        description = "Creates a profile of new restaurant."
)
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Successfully saved restaurant.",
...
@Inherited
public @interface RestaurantSaveOpenApi {
}