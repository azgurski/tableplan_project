...
@Operation(
        summary = "Gets a schedule of weekday by restaurant id.",
        description = "For example, all default open times for Saturday.",
        tags = "Hateoas"
)
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Successfully loaded schedule.",
        ...
        @ApiResponse(responseCode = "404", description = "Restaurant or schedule not found.", content =
                {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorContainer.class))})
})
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Inherited
public @interface DefaultWeekDayFindOneByDayOfWeekAndRestaurantIdOpenApi {
}