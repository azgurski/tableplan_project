...
@Operation(
        summary = "Gets calendar day availability by date and restaurant id.",
        description = "Gets calendar day availability by date and restaurant id.",
        tags = "Hateoas"
)
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Successfully loaded calendar day.",
        ...
        @ApiResponse(responseCode = "404", description = "Restaurant or calendar day not found.", content =
                {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorContainer.class))})
})
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Inherited
public @interface CalendarDayFindOneByDateAndRestaurantIdOpenApi {
}