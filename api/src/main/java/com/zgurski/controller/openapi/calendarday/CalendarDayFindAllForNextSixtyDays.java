...
@Operation(
        summary = "Gets restaurant's availability for next 60 days.",
        description = "Gets restaurant's availability for next 60 days including today.",
        tags = "Hateoas"
)
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Successfully loaded availabilities.",
...
@Inherited
public @interface CalendarDayFindAllForNextSixtyDays {
}