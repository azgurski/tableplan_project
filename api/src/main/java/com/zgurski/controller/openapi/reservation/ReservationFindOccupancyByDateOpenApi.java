...
@Operation(
        summary = "Gets number of guests per timeslot for date and restaurant.",
        description = "Postgres function of sum, group by time for confirmed reservation.")
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Occupancy as timeslot-number of guests.",
...
@Inherited
public @interface ReservationFindOccupancyByDateOpenApi {
}