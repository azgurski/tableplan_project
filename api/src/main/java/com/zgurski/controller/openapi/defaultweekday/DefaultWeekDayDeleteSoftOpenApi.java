...
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Default week day with {id} is softDeleted successfully.",
        ...
        @ApiResponse(responseCode = "404", description = "Restaurant or default weekday not found by id.", content =
                {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorContainer.class))})
})
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Inherited
public @interface DefaultWeekDayDeleteSoftOpenApi {
}