...
@Operation(
        summary = "Updates default week.",
        description = "Updates default week day."
)
@ApiResponses({
        @ApiResponse(responseCode = "200", description = "Successfully updated default week day.",
        ...
        @ApiResponse(responseCode = "404", description = "Default week day not found by id.", content =
                {@Content(mediaType = "application/json", schema = @Schema(implementation = ErrorContainer.class))})
})
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE})
@Retention(RetentionPolicy.RUNTIME)
@Inherited
public @interface DefaultWeekDayUpdateOpenApi {
}